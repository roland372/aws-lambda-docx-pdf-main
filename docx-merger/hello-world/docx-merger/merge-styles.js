...
export const prepareStyles = function (files, style) {
    // var self = this;
...
export const mergeStyles = function (files, _styles) {
...
export const updateStyleRel_Content = function (zip, fileIndex, styleId) {
...
export const generateStyles = function (zip, _style) {
    var xml = zip.file('word/styles.xml').asText();
